...
class RecommendationInfrastructureTypePriority(Base):
    """
    추천별 인프라 우선순위 모델
    ...
    __tablename__ = "recommendation_infrastructure_type_priority"
    ...
    recommendation: Mapped["Recommendation"] = relationship("Recommendation", back_populates="infrastructure_type_priorities")
